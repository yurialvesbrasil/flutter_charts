...
class HorizontalBarLabelChart extends StatelessWidget {
  ...
  factory HorizontalBarLabelChart.withSampleData(Orientation orientation) {
    return new HorizontalBarLabelChart(
      _createSampleData(orientation),
  ...
  factory HorizontalBarLabelChart.withRandomData(Orientation orientation) {
    return new HorizontalBarLabelChart(_createRandomData(orientation));
  }
